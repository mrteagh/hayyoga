<x-layout>
    ...
    <main>
        <section class="hero">
            ...
            <h3 class="fw-bold fs-3 p-3 bg-black rounded w-50">Não é apenas um curso, é uma jornada através do autoconhecimento!</h3>
            ...
            <section id="vamosComecar" class=" border-1 vw-100">

                <H2 class="display-1 fw-bold">VAMOS COMEÇAR?</H2>
                <div>
                    <div id="caixa">
                    ...
                    <div id="texto">
                        <p>
                            O programa é coordenado e ministrado por <strong>HayanaDevi</strong>. <br>
                            Desde 2004 leciona e pratica Yoga <br>
                            Praticante de Artes Marciais e estudante de várias filosofias orientais, encontrou no Yoga o
                            seu
                            caminho de vida. <br>

                            Bacharel em Educação Física, especialista em Reabilitação, Neurociência, Docência da
                            Meditação e
            ...
            <H2>LINHAS DO YOGA EM QUE ATUA:</H2>
            ...
            <section id="vamosComecar">
                ...
                <div>
                    <div id="texto">
                        <p>
                        <ul>
                            <li>Yogaterapia (gravidas, crianças e grupos de reabilitação e terapeutica holistica);</li>
                            <li>Tantra Kundalini Yoga</li>
                            <li>Hatha Yoga</li>
            ...
            <section id="certificacao">
                ...
                <p></p>
                <p>Possibilita ao discente, que assim desejarem o ingresso e certificação nos sindicatos de
                    Terapeutas.</p>
                <p>Habilitado como instrutor de yoga do metodo <strong>DESPERTARYOGA</strong></p>

            </section>

            <section class="cronograma">

                <h3 class="d-flex fw-bold display-1 p-3">CRONOGRAMA GERAL</h3>
                <UL>
                    <LI>FILOSOFIA DO YOGA</LI>
                    <LI>HISTORIA DO YOGA E HINDUISMO</LI>
                    <LI>CONCEITOS E SIGNIFICADOS DO YOGA</LI>
                    <LI>YOGA SAMKHYA, VEDANTA E TANTRA</LI>
                    <LI>ASTHANGA YOGA DE PATANJALI, HATHA YOGA E OUTROS TIPOS DE YOGA</LI>
                    <LI>PRATICAS ORIENTAIS X COMPORTAMENTO OCIDENTAL</LI>
                    <LI>YAMAS E NYAMAS</LI>
                    <LI>YOGA SUTRA DE PATANJALI</LI>
                    <LI>KARMA E DHARMA</LI>
                </UL>
                        ...
                        <div class="card3-content">
                            ...
                            <div id="abrirModal3" class="modal3">
                                <div class="modal3-conteudo">
                                    ...
                                    <p>
                                    <UL>
                                        <LI>PRANAYAMAS - Mecanica respiratória, fisiologia e biomecanica respiratoria,
                                            prana e pranayama.
                                        </LI>
                                        <LI>ASANAS - Posturas fisicas e psicofisicas (sistemas do corpo fisico, auste e
                                            alinhamento)</LI>
                                        <LI>KRIYAS - Purificações, organicas, Bhutashuddhi (energetica e emocional).
                                        </LI>
                                        <LI>MEDITAÇÃO </LI>
                                        <LI>SAMADHI - MAUNA (silencio), PRATYAHARA (abstração dos sentidos), DHARANA
                                            (concentração), DHYANA
                                            (meditação) E SAMADHI (hiperconsciencia)
                                        </LI>
                                    </UL>
                                    </p>
                                </div>
                        ...
                        <div class="card4-content">
                            ...
                            <div id="abrirModal4" class="modal4">
                                <div class="modal4-conteudo">
                                    ...
                                    <UL>
                                        <LI>MUDRAS - Gestos simbolicos e energeticos com as mãos e com o corpo (BHANDAS
                                            E DHSHTI)</LI>
                                        <LI>YOGANIDRA- Sono yogui e relaxamento profundo</LI>
                                        <LI>MANTRAS- Entendendo os mantras no <strong>YOGA</strong> </LI>
                                        <LI>YANTRA YOGA- Estudo das simbologias do <strong>YOGA</strong> (YANTRAS E
                                            MANDALAS)</LI>
                                        <LI>PUJA- Ritualisticas e gratidão.</LI>
                                        <LI>SANKALPA- Fortalecimento interno</LI>
                                    </UL>
                        ...
                        <div class="card5-content">
                            ...
                            <div id="abrirModal5" class="modal5">
                                <div class="modal5-conteudo">
                                    ...
                                    <ul>
                                        <li>PRANA- Energia vital</li>
                                        <li>KOSHAS- Corpo fisico, mental, emocional,e espiritual.</li>
                                        <li>NADIS E KUNDALINÍ </li>
                                        <li>CHAKRAS </li>
                                        <li>PRATICAS </li>
                                    </ul>
                        ...
                        <div class="card6-content">
                            ...
                            <div id="abrirModal6" class="modal6">
                                <div class="modal6-conteudo">
                                    ...
                                    <UL>
                                        <LI>ASTHANGA YOGA FLOW</LI>
                                        <LI>HATHA YOGA </LI>
                                        <LI>RAJA YOGA </LI>
                                        <LI>TANTRA YOGA (contração e expansão)</LI>
